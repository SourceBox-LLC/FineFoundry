            ...
            ft.Container(
                content=ft.Column([
                    section_title(
                        ...
                        on_help_click=mk_help_handler("Shows CPU, RAM, disk, GPU, and CUDA status to gauge local fine‑tuning readiness."),
                    ),
                    ft.Container(
                        content=ft.Column([
                            ...
                            section_title(
                                ...
                                on_help_click=mk_help_handler("Runs the training script inside the selected Docker image with your dataset mounted at /data. Uses the same command builder as Runpod."),
                            ),
