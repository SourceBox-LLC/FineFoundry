...
1. **Choose your data** — Select the dataset you collected earlier
1. **Click Start** — Watch as the AI learns from your examples
...
1. **Choose your dataset** from the dropdown (your collected data)
1. **Pick a preset:**
...
1. **Watch the logs** — You'll see progress updates as training happens
...
1. **Select "Runpod - Pod"** as your training target
1. **Choose your dataset** from the dropdown
1. **Pick a GPU type** (RTX 4090 is a good balance of speed and cost)
...
1. **See the response** — Does it match what you expected?
...
1. Give it a descriptive name (like "Reddit bot v1")
1. Your settings are now saved
