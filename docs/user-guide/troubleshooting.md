...
2. **In Expert mode, reduce batch size** — Try 1 or 2
3. **Close other programs** — Games, browsers with lots of tabs
4. **Use Runpod instead** — Cloud GPUs have more memory
...
2. **Check the logs** — Look for red error messages
3. **Try smaller settings** — Fewer threads, smaller batch size
4. **Test your connection** — Can you browse the web normally?
...
2. **Ask the community:** [GitHub Discussions](https://github.com/SourceBox-LLC/FineFoundry/discussions)
